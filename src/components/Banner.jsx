...
function Banner(){
    return(
        <div className='banner-bg flex flex-col lg:flex-row lg:flex-nowrap lg:py-5'>
            <h1 className='text-[5em] text-center lg:basis-1/3'><Link to="/">Business Name</Link> <p className="text-[0.75rem] text-center animate-bounce animate-infinite animate-ease-in">☝️ In some cases you can make this clickable as a way to get back to the main page. ☝️</p></h1>
