...
function Contact(){
    return(
        <div className='min-h-[100vh] relative'>
            ...
            <p className='text-[1.5rem] lg:text-[2rem]'>Same for the telephone number for mobile devices! <a href='tele: +15555555555' className='text-blue-700' >555-555-5555</a></p>  
            </div>
